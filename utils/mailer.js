...
async function sendOrderNotification(order) {
  ...
  if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
    console.log("⚠️ Email not configured — skipping owner notification");
    return;
  }
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="background:#3D7A4F;padding:24px;text-align:center">
            ...
            <h2 style="color:white;margin:0;font-size:1.4rem">Order Received!</h2>
          </div>
          <div style="background:white;padding:32px;border:1px solid #eee">
...
async function sendStatusUpdateEmail(order) {
  ...
  const statusMessages = {
    ...
    shipped: {
      ...
      message:
        "Your order has been shipped and is on its way to you. Expect delivery very soon!",
      color: "#185FA5",
    },
    delivered: {
      emoji: "🎉",
  ...
  if (!info) {
    console.log("⚠️ No email template for status:", order.status);
    return;
  }
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          <div style="background:#2C1A0E;padding:28px;text-align:center;border-radius:8px 8px 0 0">
            ...
            <p style="color:#C47E3A;margin:8px 0 0">Order Update</p>
          </div>
